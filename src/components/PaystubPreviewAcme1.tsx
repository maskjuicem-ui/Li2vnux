...
export default function PaystubPreviewAcme1({ data }: PaystubPreviewProps) {
  ...
  return (
    <div id="paystub-preview" className="bg-white p-12 min-h-[1100px] font-sans">
      <div className="max-w-5xl mx-auto bg-white">
        ...
        <div className="bg-slate-200 p-6 mb-8 rounded">
          <div className="text-center mb-4">
            <h3 className="text-xl font-bold text-slate-800">{data.school_name}</h3>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <div>
              <div className="mb-4">
                <p className="text-sm font-bold text-slate-700">Payee Name</p>
              ...
              <div>
                <p className="text-sm font-bold text-slate-700">Employee ID</p>
                <p className="text-base text-slate-900">{data.file_number}</p>
              </div>
            </div>
            <div>
              <div className="mb-4">
                <p className="text-sm font-bold text-slate-700">Marital Status</p>
                <p className="text-base text-slate-900">Single</p>
              </div>
              <div className="mb-4">
                <p className="text-sm font-bold text-slate-700">Check Number</p>
                <p className="text-base text-slate-900">{data.check_number}</p>
              </div>
              <div>
                <p className="text-sm font-bold text-slate-700">SSN</p>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            <div className="bg-slate-200 px-4 py-3 mb-4">
              <h4 className="font-bold text-slate-800 text-center">Payments</h4>
            </div>
          ...
          <div>
            <div className="bg-slate-200 px-4 py-3 mb-4">
              <h4 className="font-bold text-slate-800 text-center">Year to date</h4>
            </div>
            <div className="border-b border-slate-300 pb-4 mb-4">
              <div className="flex justify-between items-center">
                <span className="font-bold text-slate-900">Regular Pay</span>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div>
            <div className="bg-slate-200 px-4 py-3 mb-4">
              <h4 className="font-bold text-slate-800 text-center">Deductions</h4>
            </div>
        ...
        <div className="bg-slate-200 p-6 mb-8">
          <div className="flex justify-between items-center">
            <p className="text-lg">
            ...
            <p className="text-2xl font-bold">{formatCurrency(data.net_pay_current)}</p>
          </div>
        </div>
      </div>
    </div>
