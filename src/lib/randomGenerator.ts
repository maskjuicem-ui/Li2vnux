...
export async function generateRandomPaystub(): Promise<Paystub> {
  ...
  const schools = [
    ...
    { name: 'Harvard University', location: 'Cambridge, MA 02138', code: 'HRV001' },
    { name: 'Stanford University', location: 'Stanford, CA 94305', code: 'STN002' },
    { name: 'Massachusetts Institute of Technology', location: 'Cambridge, MA 02139', code: 'MIT003' },
    { name: 'Yale University', location: 'New Haven, CT 06520', code: 'YLE004' },
    { name: 'Princeton University', location: 'Princeton, NJ 08544', code: 'PRC005' },
    { name: 'Columbia University', location: 'New York, NY 10027', code: 'CLM006' },
    { name: 'University of Chicago', location: 'Chicago, IL 60637', code: 'UCH007' },
    { name: 'University of Pennsylvania', location: 'Philadelphia, PA 19104', code: 'UPN008' },
    { name: 'Duke University', location: 'Durham, NC 27708', code: 'DKE009' },
    { name: 'Northwestern University', location: 'Evanston, IL 60208', code: 'NWU010' },
    { name: 'University of California Berkeley', location: 'Berkeley, CA 94720', code: 'UCB011' },
    { name: 'University of Michigan', location: 'Ann Arbor, MI 48109', code: 'UMI012' },
    { name: 'Cornell University', location: 'Ithaca, NY 14853', code: 'CRN013' },
    { name: 'University of Texas Austin', location: 'Austin, TX 78712', code: 'UTA014' },
    { name: 'New York University', location: 'New York, NY 10003', code: 'NYU015' },
    { name: 'Boston University', location: 'Boston, MA 02215', code: 'BSU016' },
    { name: 'University of Southern California', location: 'Los Angeles, CA 90089', code: 'USC017' },
    { name: 'Georgetown University', location: 'Washington, DC 20057', code: 'GTN018' },
    { name: 'Carnegie Mellon University', location: 'Pittsburgh, PA 15213', code: 'CMU019' },
    { name: 'University of Virginia', location: 'Charlottesville, VA 22904', code: 'UVA020' },
  ...
  const positions = [
    ...
    'Professor of Mathematics', 'Associate Professor of English', 'Assistant Professor of Biology', 'Professor of Computer Science',
    'Lecturer in Physics', 'Senior Lecturer in Chemistry', 'Professor of Economics', 'Associate Professor of History',
    'Professor of Psychology', 'Assistant Professor of Sociology', 'Professor of Business Administration', 'Lecturer in Engineering',
    'Professor of Political Science', 'Associate Professor of Philosophy', 'Professor of Law', 'Assistant Professor of Medicine',
    'Research Professor', 'Visiting Professor', 'Adjunct Professor', 'Department Chair - Mathematics',
    'Dean of Engineering', 'Academic Advisor', 'University Registrar', 'Admissions Counselor',
    'Financial Aid Officer', 'Student Affairs Director', 'Campus Security Director', 'IT Director',
    'Facilities Manager', 'Athletics Director', 'Career Services Counselor', 'Research Coordinator'
  ];
